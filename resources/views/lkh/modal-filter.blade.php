<div class="modal fade" id="modal-filter-lkh" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="myCenterModalLabel">Filter LKH</h4>
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            <label for="filter_status" class="form-label">Shift</label>
