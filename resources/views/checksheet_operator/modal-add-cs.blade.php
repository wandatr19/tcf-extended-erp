<div class="modal fade" id="modal-add-checksheet" tabindex="-1" role="dialog" aria-hidden="true">
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-primary waves-effect waves-light" id="submit_checksheet">Submit</button>
                    </div>
                </div>
            </div>
        </div>
